...
export default function UKHRMSPage() {
  ...
  return (
    <div className="min-h-screen bg-white text-slate-900 selection:bg-brand-600 selection:text-white">
      {/* Product Suite Switcher Bar */}
      <ProductSuiteSwitcher activeSuiteId="hrms" />

      {/* Hero Section */}
      <section className="relative pt-20 pb-20 overflow-hidden bg-gradient-to-b from-slate-50 via-white to-slate-50 border-b border-slate-200/60">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-center">
          <motion.div
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
            transition={{ duration: 0.5 }}
            className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-brand-50 border border-brand-200 text-brand-700 text-sm font-bold mb-6"
          >
          ...
          <motion.h1
            ...
            className="text-4xl sm:text-6xl lg:text-7xl font-extrabold tracking-tight text-slate-900 max-w-4xl mx-auto leading-tight"
          >
          ...
          >
            <a
              href="#contact"
              className="w-full sm:w-auto px-8 py-4 rounded-xl bg-brand-600 hover:bg-brand-700 font-bold text-white shadow-lg shadow-brand-600/20 hover:scale-[1.02] active:scale-[0.98] transition-all flex items-center justify-center gap-2"
            >
          ...
          <div className="mt-8 pt-4 inline-flex flex-wrap justify-center items-center gap-6 text-xs font-semibold text-slate-600 border-t border-slate-200">
            <span className="flex items-center gap-1.5"><ShieldCheck className="w-4 h-4 text-emerald-600" /> HMRC PAYE RTI Ready</span>
            <span className="flex items-center gap-1.5"><Lock className="w-4 h-4 text-brand-600" /> GDPR &amp; AES-256 Encrypted</span>
            <span className="flex items-center gap-1.5"><Globe className="w-4 h-4 text-sky-600" /> UK Support &amp; Onboarding</span>
          </div>
        </div>
      </section>
      ...
      <section className="py-20 bg-slate-50 border-b border-slate-200/60">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-3xl mx-auto mb-16">
            <h2 className="text-3xl sm:text-4xl font-extrabold text-slate-900">10 Core Pillars of Worklynx HRMS</h2>
            <p className="mt-4 text-slate-600 text-lg">Designed from the ground up to solve complex UK HR, payroll, and workforce operations.</p>
          </div>
              ...
              return (
                ...
                >
                  <div className="flex items-center justify-between mb-4">
                    <div className="w-12 h-12 rounded-xl bg-brand-50 border border-brand-100 flex items-center justify-center text-brand-600 group-hover:bg-brand-600 group-hover:text-white transition-all">
      ...
      <section className="py-16 bg-white">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <div className="p-8 sm:p-12 rounded-3xl bg-brand-50/50 border border-brand-200 relative overflow-hidden shadow-xs">
            <div className="relative z-10">
              <span className="text-xs font-extrabold uppercase tracking-widest text-brand-700">Integrated Ecosystem</span>
              <h2 className="text-2xl sm:text-4xl font-extrabold text-slate-900 mt-2">Need more than HRMS?</h2>
              ...
              <div className="mt-8 flex flex-wrap justify-center gap-4">
                <Link
                  ...
                  className="px-6 py-3 rounded-xl bg-white border border-amber-300 hover:bg-amber-50 text-amber-800 text-sm font-bold shadow-xs transition-all"
                >
                  Explore Inventory ERP &rarr;
                </Link>
                <Link
                  to="/restaurant-management"
                  className="px-6 py-3 rounded-xl bg-white border border-rose-300 hover:bg-rose-50 text-rose-800 text-sm font-bold shadow-xs transition-all"
                >
