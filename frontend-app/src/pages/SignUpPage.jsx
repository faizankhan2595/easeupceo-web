    ...
    <div className="min-h-screen bg-gradient-to-br from-indigo-50 via-white to-slate-50 pt-24 pb-12 px-4">
      <div className="max-w-2xl mx-auto">
        <div className="text-center mb-8">
          ...
          <p className="text-slate-600">7 days free. No credit card. Setup in 5 minutes.</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="bg-white rounded-2xl shadow-xl border border-slate-200 p-6 sm:p-8 space-y-5">
          ...
          <div className="rounded-xl bg-slate-50 border border-slate-200 p-4">
            ...
            <div className="text-xs text-slate-500 mb-3">
              7 days free with every module unlocked. Your chosen plan starts with your first payment — switch any time.
            </div>
          ...
          >
            {submitting ? "Creating workspace…" : "Start 7-Day Free Trial →"}
          </button>
