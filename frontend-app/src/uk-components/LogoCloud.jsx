...
const trustedCompanies = [
  { name: "Apex Retail Group", category: "UK Retail", desc: "120+ Employees in London & Manchester" },
  { name: "Vanguard Tech UK", category: "Software", desc: "Automated HMRC Payroll & Pension" },
    ...
    <section className="py-10 bg-slate-50/50 border-b border-slate-200/60 overflow-hidden">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <p className="text-center text-xs font-semibold text-slate-500 uppercase tracking-widest mb-6">
          Trusted by 500+ Modern UK Businesses
        </p>
